...
if ($metai >= $Vašingtonas[1]) { //Sukurk if sąlygą, kuri patikrina ar $metai yra daugiau arba lygu už Vašingtono įkūrimo metus (panaudok $cities3 masyvo duomenis)
	echo $sostinė .' yra ' . $Vašingtonas[2] . ' sostinė.' ; //Jei atsakymas teigiamas, išvesk tekstą: “Vašingtonas yra JAV sostinė.”
} 
elseif ($metai = 1774) { //Sukurk elseif sąlygą patikrinti ar $metai lygu 1774. Jei atsakymas teigiamas, išvesk tekstą: “JAV sostinė vis dar Filadelfijoje.”
	echo $Vašingtonas[2] . ' sostinė vis dar Filadelfijoje.';
}
	...
	echo 'Liko ' . $total=$Vašingtonas[1]-$metai . ' metai (-ų) iki Vašingtono įkūrimo.';
}
